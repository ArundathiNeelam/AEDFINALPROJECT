 ...
 * @author bhuvana
 */
public class OfficerWAJPanel extends javax.swing.JPanel {

    private JPanel jPanel;
    private UserAccount usrAcnt;
    private HCOfficerOrganz hlthCrOfcrJPanel;
    private En entrpz;

    /**
     * Creates new form OfficerWorkAreaJPanel1
     */
    public OfficerWAJPanel(JPanel jpanel, UserAccount userAccount, Org organization, En enterprise) {
        initComponents();
        this.entrpz = enterprise;

        this.jPanel = jpanel;

        this.hlthCrOfcrJPanel = (HCOfficerOrganz) organization;
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (selectedRow < 0) {
            ...
            WR req = (GovtFundRequest) workRequestJTable.getValueAt(selectedRow, 0);
    ...
    private void processRequestBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processRequestBtnActionPerformed
        ...
        if (slRow < 0) {
            ...
            GovtFundRequest request = (GovtFundRequest) workRequestJTable.getValueAt(slRow, 0);
            ...
            if (!usrAcnt.getEmp().equals(request.getReceiver().getEmp())) {
                ...
                OfficerProcessWRJPanel panel = new OfficerProcessWRJPanel(jPanel, usrAcnt, request, entrpz);
    ...
    public void pplTbl() {
        ...
        for (WR req : hlthCrOfcrJPanel.getWrkQ().getWorkRequests()) {
            Object[] row = new Object[5];
            String status = req.getStatus();
            row[0] = ((GovtFundRequest) req);
            ...
            row[3] = req.getStatus();
            row[4] = ((GovtFundRequest) req).getReqAmt();
