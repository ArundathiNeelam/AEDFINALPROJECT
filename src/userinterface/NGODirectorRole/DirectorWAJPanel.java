 ...
 * @author bhuvana
 */
public class DirectorWAJPanel extends javax.swing.JPanel {
    ...
    private NGODirectorOrg ngoDirOrg;
    private En ent;

    public DirectorWAJPanel(JPanel jpanel, UserAccount userAccount, Org organization, En enterprise) {
        initComponents();
        this.ent = enterprise;
        this.jPnl = jpanel;
        this.ngoDirOrg = (NGODirectorOrg) organization;
    ...
    private void initComponents() {
        ...
        btnAss.setBackground(new java.awt.Color(204, 204, 204));
        ...
        processReqBtn.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void btnAssActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            WR request = (NGOFundRequestt) dirWrkReqTbl.getValueAt(selectedRow, 5);
    ...
    private void processReqBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processReqBtnActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            NGOFundRequestt request = (NGOFundRequestt) dirWrkReqTbl.getValueAt(selectedRow, 5);
            ...
            DPWorkRequestJPanel directorProcessWorkRequestJPanel = new DPWorkRequestJPanel(jPnl, request);
    ...
    public void populateTable() {
        ...
        for (WR request : ngoDirOrg.getWrkQ().getWorkRequests()) {
            ...
            row[2] = status;
            row[3] = ((NGOFundRequestt) request).getNeededamtreq();
            row[4] = ((NGOFundRequestt) request).getWrMsg();
            row[5] = request;
