 ...
 * @author bhuvana 
 */
public class RBJPanel extends javax.swing.JPanel {

    private JPanel jPanel;
    private UserAccount usrAcnt;
    private En entrpz;
    private PatientTreatmentWR pntTrtmntWrkReq;
     ...
     */
    RBJPanel(JPanel userProcessContainer, UserAccount userAccount, En enterprise, PatientTreatmentWR workRequest) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(290, 110, 220, 30);

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel6.setText("PATIENT INFORMATION");
        add(jLabel6);
        jLabel6.setBounds(290, 190, 180, 17);
        ...
        add(jLabel4);
        jLabel4.setBounds(220, 390, 177, 21);
        ...
        add(jLabel5);
        jLabel5.setBounds(220, 460, 168, 21);
        add(medChrgTxt);
        ...
        add(jLabel11);
        jLabel11.setBounds(220, 430, 157, 21);
        ...
        add(labChrgTxt);
        labChrgTxt.setBounds(410, 430, 82, 23);
        ...
        sndBillReqBtn.setBackground(new java.awt.Color(204, 204, 204));
        ...
        add(sndBillReqBtn);
        sndBillReqBtn.setBounds(300, 540, 137, 32);
    ...
    private void sndBillReqBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sndBillReqBtnActionPerformed
        ...
        if (consultationCharge.equals("") || labChargesStr.equals("") || miscellaneouschargesStr.equals("") || medicationChargesStr.equals("")) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                ABillingRequest accountantBillingRequest = new ABillingRequest();
                ...
                for (Org organization : entrpz.getOrgDir().getOrganizations()) {
                    ...
                    if (organization instanceof AccountantOrgnz) {
                        org = organization;
                        break;
                    }
                }
