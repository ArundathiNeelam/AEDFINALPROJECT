 ...
 * @author arundathi
 */
public class BBRequestJPanel extends javax.swing.JPanel {

    private JPanel jPanel;
    private En entrpz;
    private UserAccount usrAcnt;
    private PatientTreatmentWR pntTrWrkReq;

   
    public BBRequestJPanel(JPanel userProcessContainer, UserAccount account, En enterprise, PatientTreatmentWR patientTreatmentWorkRequest) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 80, 130, 20));
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        ...
        String  bloodUnits = txtLabType.getText().trim();            
            try {
                ...
                JOptionPane.showMessageDialog(null, "Please enter integer values in the Blood Units textfield.");
                return;
            }
        ...
        for (Org organization : entrpz.getOrgDir().getOrganizations()) {
            ...
            if (organization instanceof BloodBMOrganz) {
                org = organization;
                break;
            }
        }
