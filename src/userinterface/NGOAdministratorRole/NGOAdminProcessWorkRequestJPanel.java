 ...
 * @author bhuvana
 */
public class NGOAdminProcessWorkRequestJPanel extends javax.swing.JPanel {
    ...
    private NGOFundRequestt ngoFndReq;
    private OfficerWAJPanel offrWrkAreaJPnl;

    public NGOAdminProcessWorkRequestJPanel(JPanel jPanel, UserAccount userAccount, NGOFundRequestt fundRequest, En enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        sendRequestToDirectoryBtn.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void sendRequestToDirectoryBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendRequestToDirectoryBtnActionPerformed
        ...
        if (message.equals("")) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                Org org = null;
                for (Org organization : ent.getOrgDir().getOrganizations()) {
                    if (organization instanceof NGODirectorOrg) {
                        org = organization;
                        break;
                    }
                }
