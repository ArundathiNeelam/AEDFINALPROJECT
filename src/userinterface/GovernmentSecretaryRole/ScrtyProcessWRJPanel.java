 ...
 * @author arundathi
 */
public class ScrtyProcessWRJPanel extends javax.swing.JPanel {
    ...
    private GovtFundRequest governmentFundRequest;

    public ScrtyProcessWRJPanel(JPanel jPanel, UserAccount userAccount, GovtFundRequest fundRequest, En enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        sendRequestToTreasurerBtn.setBackground(new java.awt.Color(204, 204, 204));
        sendRequestToTreasurerBtn.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        sendRequestToTreasurerBtn.setText("Send Request");
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        ScrtyWAJPanel swjp = (ScrtyWAJPanel) component;
        swjp.ppltTbl();
