 ...
 * @author arundathi
 */
public class ScrtyWAJPanel extends javax.swing.JPanel {
    ...
    public ScrtyWAJPanel(JPanel jpanel, UserAccount userAccount, Org organization, En enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        asgnBtn.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void asgnBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_asgnBtnActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            WR req = (GovtFundRequest) wrkReJqTable.getValueAt(selectedRow, 0);
    ...
    private void prcsReqBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_prcsReqBtnActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            GovtFundRequest fundReq = (GovtFundRequest) wrkReJqTable.getValueAt(selectedRow, 0);
            ...
            ScrtyProcessWRJPanel secPrcWrkreqJPanel = new ScrtyProcessWRJPanel(jPanel, usrAcnt, fundReq, entrpz);
    ...
    public void ppltTbl() {
        ...
        for (WR req : secOrg.getWrkQ().getWorkRequests()) {
            ...
            row[5] = ((GovtFundRequest) req).getWrMsg();
