 ...
 * @author arundathi
 */
public class ManageUAJPanel extends javax.swing.JPanel {
    ...
    public ManageUAJPanel(JPanel container, En enterprise) {
        initComponents();
    ...
    public void pplEmpCmbx(Org organization) {
        employeeJComboBox.removeAllItems();

        for (Emply employee : organization.getEmpDir().getEmpList()) {
            employeeJComboBox.addItem(employee);
        }
    }

    private void popRoleCmbx(Org organization) {
    ...
    private void initComponents() {
        ...
        jLabel7.setFont(new java.awt.Font("Telugu MN", 1, 24)); // NOI18N
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        Emply employee = (Emply) employeeJComboBox.getSelectedItem();
        ...
        if (userName == null || userName.equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "Enter your username here");
            return;
        }
        ...
        if (password == null || password.equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "Enter your password here.");
            return;
        }

        if (!passwordPatternCorrect()) {
            JOptionPane.showMessageDialog(null, "Password should Minimum contain  6 characters "
        ...
        if (!password.equals(rePassword)) {
            JOptionPane.showMessageDialog(null, " Kindly use the same password.");
            passwordJTextField.setBorder(BorderFactory.createLineBorder(Color.RED));
