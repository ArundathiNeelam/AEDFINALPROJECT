 ...
 * @author bhuvana
 */
public class ManageEmplyJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageEmplyJPanel(JPanel userProcessContainer, OD organizationDir) {
        initComponents();
    ...
    public void pplOrgCmbx() {
        ...
        for (Org organization : orgDir.getOrganizations()) {
    ...
    private void pplTbl(Org organization) {
        DefaultTableModel model = (DefaultTableModel) organizationJTable.getModel();

        model.setRowCount(0);

      
        for (Emply emp : organization.getEmpDir().getEmpList()) {
            Object[] row = new Object[2];
            row[0] = emp.getEmpId()-2;
    ...
    private void initComponents() {
        ...
        jLabel4.setFont(new java.awt.Font("Telugu MN", 1, 24)); // NOI18N
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        Org organization = (Org) orgEmpJComboBox.getSelectedItem();
    ...
    private void orgJComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_orgJComboBoxActionPerformed
        Org organization = (Org) orgJComboBox.getSelectedItem();
