...
public class NGORequestFundsJPanel extends javax.swing.JPanel {
     ...
     */
    public NGORequestFundsJPanel(JPanel jPanel, En enterprise, UserAccount userAccount, EcoSystem ecoSystem) {
     ...
     // TODO add your handling code here:
        ...
        if(hospname.equals("") || hospaddress.equals("")||neededamtreq.equals("")){
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "For the contribution field, kindly enter an integer value.");
                return;
            }

            NGOFundRequestt ngoFundRequest = new NGOFundRequestt(hospname,hospaddress, Integer.parseInt(neededamtreq));
            ...
            for (Network network : networks) {
                ...
                for (En enterprise : enterprises) {
                    ...
                    for (Org organization : organizations) {
                        if (organization instanceof NGOAdminOrg) {
                            org = organization;
                            break;
                        }
                    }
    ...
    private void populateNGORequestTable() {
        ...
        int totalreqFunds = 0;
        model.setRowCount(0);
        for (WR request : userAccount.getWrkQ().getWorkRequests()) {
            if(request instanceof NGOFundRequestt){
            Object[] row = new Object[4];
            row[0] = String.valueOf(((NGOFundRequestt) request).getHospname());
            row[1] = String.valueOf(((NGOFundRequestt) request).getHospaddress());
            row[2] = String.valueOf(((NGOFundRequestt) request).getNeededamtreq());
            row[3] = request.getStatus();
            model.addRow(row);
            if (request.getStatus().equalsIgnoreCase("Accepted")) {
                totalreqFunds += ((NGOFundRequestt) request).getNeededamtreq();
            }
            }
        }
