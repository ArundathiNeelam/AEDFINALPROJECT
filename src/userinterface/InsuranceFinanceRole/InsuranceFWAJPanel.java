 ...
 * @author bhuvana
 */
public class InsuranceFWAJPanel extends javax.swing.JPanel {

    private JPanel jPanel;
    
    private UserAccount usrAcnt;
    private IFOrganization insrFincOrg;
    private En entrpz;

    /**
     * Creates new form InsuranceFinanceWorkAreaJPanel
     */
    public InsuranceFWAJPanel(JPanel userProcessContainer, UserAccount account, IFOrganization insuranceFinanceOrganization, En enterprise) {
        initComponents();
    ...
    private void asgnToMeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_asgnToMeBtnActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            WR req = (InsuranceWR) financJTable.getValueAt(selectedRow, 0);
    ...
    private void prcsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_prcsBtnActionPerformed
        ...
        if (selRow < 0) {
            ...
            InsuranceWR insrWrReq = (InsuranceWR) financJTable.getValueAt(selRow, 0);
            ...
            if (insrWrReq.getStatus().equals("Insurance Claim Rejected")) {
                ...
                InsuranceFPR panel = new InsuranceFPR(jPanel, usrAcnt, insrWrReq, entrpz);
    ...
    public void pplTabl() {
        ...
        for (WR workRequest : insrFincOrg.getWrkQ().getWorkRequests()) {
            InsuranceWR insrWkReq = ((InsuranceWR) workRequest);
