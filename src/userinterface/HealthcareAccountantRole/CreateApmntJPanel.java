 ...
 * @author arundathi
 */
public class CreateApmntJPanel extends javax.swing.JPanel {
     ...
     */
    CreateApmntJPanel(JPanel userProcessContainer, UserAccount userAccount, En enterprise, EcoSystem ecoSystem, String patientId) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnFindPatient.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jLabel9.setFont(new java.awt.Font("Telugu MN", 1, 14)); // NOI18N
        ...
        lblHavePolicy.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        lblInsCompany.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        jLabel11.setFont(new java.awt.Font("Telugu MN", 1, 14)); // NOI18N
        ...
        lblPolicyNum.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        btnFindInsurance.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        btnResetPolicyNum.setBackground(new java.awt.Color(204, 204, 204));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(txtPatientEmail, javax.swing.GroupLayout.DEFAULT_SIZE, 270, Short.MAX_VALUE)
                                    .addGap(319, 319, 319)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(38, 38, 38)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(doctorTypeJComboBox1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtPolicyName, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(261, 261, 261)
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (buttonGroup1.isSelected(null)) {
            JOptionPane.showMessageDialog(null, "Please select if Patient covered by Insurance");
            return;
        }
        
        if (txtReasonForVisit.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please enter your reason for visit");
            return;
        ...
        if (!usernamePatternCorrect(txtPatientEmail.getText().trim())) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Please provide integer values in Age field");
                return;
            }
            ...
            if (radioBtnPatientInsuranceYes.isSelected()) {
                if (policyNumber.equals("")) {
                    JOptionPane.showMessageDialog(null, "Please enter policy number");
                    return;
                }
            ...
            InsuranceCust insuranceCustomer = new InsuranceCust(insurance, policyNumber);
            
            HealthcenterEN healthCenterEnterprise = (HealthcenterEN) enterprise;
            ...
            PatientTreatmentWR patientTreatmentWorkRequest = new PatientTreatmentWR(registrationDate, reasonForVisit, patient);
            ...
            for (Org organization : enterprise.getOrgDir().getOrganizations()) {
                if (organization instanceof DoctorOrganz) {
                    org = organization;
                    break;
                }
            }
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        AccountantWAJPanel dwjp = (AccountantWAJPanel) component;
        dwjp.pplAllPtntsTbl();
    ...
    private void btnFindPatientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindPatientActionPerformed
        ...
        List<HealthcenterEN> healthCenterEnterprises = new ArrayList<>();
        
        for (Network network : networks) {
            for (En enterprise : network.getEntDir().getEntList()) {
                if (enterprise instanceof HealthcenterEN) {
                    healthCenterEnterprises.add((HealthcenterEN) enterprise);
                }
            }
        }
        
        for (HealthcenterEN healthCenterEnterprise : healthCenterEnterprises) {
    ...
    private void btnFindInsuranceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindInsuranceActionPerformed
        ...
        String ssn = txtSSN.getText().trim();
        List<InsurancecmpnyEN> insuranceEnterprises = new ArrayList<>();
        InsuranceCust matchedCustomer = null;
        
        List<Network> networks = ecosystem.getNetworks();
        for (Network network : networks) {
            for (En enterprise : network.getEntDir().getEntList()) {
                if (enterprise instanceof InsurancecmpnyEN) {
                    insuranceEnterprises.add((InsurancecmpnyEN) enterprise);
                }
            }
        }
        
        for (InsurancecmpnyEN insuranceCompanyEnterprise : insuranceEnterprises) {
            List<InsuranceCust> insuranceCustomers = insuranceCompanyEnterprise.getInsCustDir().getInsCust();
            for (InsuranceCust insuranceCustomer : insuranceCustomers) {
        ...
        if (matchedCustomer != null) {
            ...
            JOptionPane.showMessageDialog(null, "SSN doesn't match");
