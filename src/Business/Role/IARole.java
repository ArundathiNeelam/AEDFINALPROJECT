...
import userinterface.InsuranceAgentRole.JAWAJpanel;

/**
 *
 * @author bhuvana
 */
public class IARole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Org organization, En enterprise, EcoSystem business) {
     return new JAWAJpanel(userProcessContainer, account, (IAOrganization)organization, enterprise);
    }
